...
class VirusTrack(tk.Tk):
    def __init__(self, *args, **kwargs):
        ...
        for F in (Login, SignUp, AdminHome, PenggunaHome, MenuSuhu, MenuInsertRS, MenuInsertKamar, MenuUpdateKamar, MenuBuatPesanan, MenuProsesPesanan, MenuTampilPesanan, MenuKonfirmasiPesanan, MenuTampilDataKamar):
